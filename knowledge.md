...
####Generators
* This is generated by functions using __yield__
* It can be used only once. Like first time you call generator_a, it can return you everything in it. But second time it will only return you empty list
